      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div
            ...
            className="fixed inset-0 top-[60px] z-50 bg-[var(--bg)]/98 backdrop-blur-2xl border-t border-[var(--line)] flex flex-col justify-between p-6 md:hidden overflow-y-auto"
          >
